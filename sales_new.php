            ...
            <section class="content">
                ...
                if (mysqli_num_rows($result) == 0) {
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo "<label for='date[]' class='col-sm-2 control-label'>Date: </label><div class='col-sm-3'><input type='date' min='2021-01-01' id ='date' name='date' placeholder='Enter a date' class='form-control'></div>";
                        echo "</div>";
